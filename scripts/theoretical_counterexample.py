...
mu_s = np.array([[0,0],[0,0]]) # The formulas don't take into account the means (atm)
t_Y = np.array([norm.ppf(.95), norm.ppf(.95)])
rho_list = [.85,.8]
P_Y = 0.95
...
savefig(fig_roc, 'figures/CE_ROC.png')
savefig(fig_pr, 'figures/CE_PR.png')
